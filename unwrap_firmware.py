#!/usr/bin/env python3
"""
Python 3 compatible MD380 firmware unwrap script.
Based on md380_fw.py from DVSwitch/md380tools.
The original script requires Python 2; this is a minimal Python 3 port
for unwrapping D002.032 firmware used by md380-emu.
"""

import struct
import sys

# MD380 XOR key from DVSwitch/md380tools md380_fw.py
# This key is used to decrypt the firmware image
MD380_KEY = bytes([
...
def xor_decrypt(data, key):
    """XOR decrypt data with cyclic key."""
...
def unwrap_md380_firmware(input_file, output_file):
    ...
    decrypted = xor_decrypt(encrypted_app, MD380_KEY)
    
    # Write unwrapped firmware
    with open(output_file, 'wb') as f:
        f.write(decrypted)
    
    print(f'INFO: Unwrapped {len(decrypted)} bytes to {output_file}')
...
if __name__ == '__main__':
    ...
    unwrap_md380_firmware(sys.argv[1], sys.argv[2])
